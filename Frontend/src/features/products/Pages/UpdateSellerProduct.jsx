        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-[#1a1a1a] border border-[#333] rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="sticky bottom-0 bg-[#1a1a1a] border-t border-[#333] px-4 py-3 flex justify-end gap-2 z-10 rounded-b-3xl">
              ...
              {loading ? (
                <button
                  className={`bg-[#F5C518] hover:bg-[#e0b415] text-black font-bold px-8 py-2.5 rounded-xl transition-all duration-300 shadow-lg shadow-[#F5C518]/10 active:scale-95 ${loading ? "opacity-70 cursor-not-allowed" : ""} flex justify-between gap-3`}
                >
                  <svg
